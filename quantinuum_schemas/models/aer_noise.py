...
import quantinuum_schemas.exceptions as exc
from quantinuum_schemas.models.backend_info import Register
from quantinuum_schemas.models.backend_info import (
    register_from_pytket_node as reg_from_qb,
)
from quantinuum_schemas.models.backend_info import register_to_pytket_node as reg_to_qb
...
class AerQuantumError(BaseModel):
    ...
    def noise_ops(self) -> List[Tuple["QuantumCircuit", float]]:
        ...
        try:
            ...
            from qiskit.circuit.library import PauliGate, Reset, XGate, YGate, ZGate
            from qiskit.quantum_info.operators import Kraus  # type: ignore

            # fmt: on
        except ImportError as err:
            raise exc.OptionalDependencyError(
...
class CrosstalkParams(BaseModel):
    ...
    def to_pytket_crosstalk_params(self) -> PytketCrosstalkParams:
        ...
        try:
            ...
            raise exc.OptionalDependencyError from err
